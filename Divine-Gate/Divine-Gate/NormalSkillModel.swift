...
class NormalSkillModel : Object, Codable {
    ...
    var belong : DVUnitModel?
//    let dvunits = LinkingObjects(fromType: DVUnitModel.self, property: "normalSkills")
